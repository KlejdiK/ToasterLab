...
[Chapter 2](02-network.md) covers the network design: which VMs and services I wanted, and how the VLAN segmentation was planned out before any of it was built.